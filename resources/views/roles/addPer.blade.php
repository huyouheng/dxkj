            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{trans('admin.new')}}
                            <b>{{$role->name}}</b> {{trans('admin.permission')}}</h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body">
                        <form action="{{route('role.storePer',['id'=>$role->id])}}" method="post" pjax-container
