                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="{{route('permission')}}" class="btn btn-sm btn-default form-history-back"><i
                                            class="fa fa-arrow-left"></i>&nbsp;{{trans('admin.back')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="box-body no-padding">
                        <form action="{{route('per-update',['id'=>$permission->id])}}" method="post" class="form-horizontal" pjax-container>
                            @csrf()
                            @method('PUT')
                            <div class="box-body">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="name" name="name" value="{{$permission->name}}"
                                                       class="form-control name" placeholder="不能为空,例如:查看首页" required
                                                       autofocus>
                                            </div>
                                        </div>
                                    </div>
